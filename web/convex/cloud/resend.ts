...
import { CLOUD_EMAIL_CONFIG } from "@/cloud/config";
...
function resolveOtpFromEmail() {
  if (isProductionEnvironment()) {
    return CLOUD_EMAIL_CONFIG.otpFromEmail.production.trim();
  }
  return CLOUD_EMAIL_CONFIG.otpFromEmail.nonProduction.trim();
}
