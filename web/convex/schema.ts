...
export default defineSchema({
  ...
  computeSessions: defineTable({
    ...
    computeReservationRequiredCents: v.optional(v.number()),
    computeReservationRemainingCents: v.optional(v.number()),
    computeReservationReleasedAt: v.optional(v.number()),
