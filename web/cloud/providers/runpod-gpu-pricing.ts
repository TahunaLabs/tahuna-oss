...
const RUNPOD_GPU_PRICING_ROWS: RunpodGpuPricingRow[] = [
  ...
  { gpuType: "H100 SXM",     vramGb: 80,  ramGb: 125, vcpus: 20, pricePerHour: 3.29 },
  ...
  { gpuType: "RTX 2000 Ada", vramGb: 16,  ramGb: 50,  vcpus: 8,  pricePerHour: 0.24 },
  ...
  { gpuType: "MI300X",       vramGb: 192, ramGb: 256, vcpus: 32, pricePerHour: 1.99 },
];
